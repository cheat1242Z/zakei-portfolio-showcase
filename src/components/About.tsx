    ...
    <section id="a-propos" className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 overflow-hidden rounded-3xl shadow-card ring-2 ring-primary/40">
            <img src={aboutImage} alt="À propos de moi" className="w-full h-full object-cover" />
          </div>
